...
<div class="col-md-5 align-self-center">
    <h4 class="text-themecolor">Create Expense</h4>
</div>
...
<div class="card wizard-content">
    <div class="card-body">
        <h4 class="card-title">Craete Expense</h4>
        <form class="validation" action="{{ route('expenses.store') }}" method="post" role="form" enctype="multipart/form-data">
            @csrf
