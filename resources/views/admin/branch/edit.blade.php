...
@section('breadcrumb')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Update Branch</h4>
    </div>
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('branches.update', $branch->id) }}" class="validation" role="form" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
