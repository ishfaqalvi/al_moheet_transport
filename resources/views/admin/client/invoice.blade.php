        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="text-muted">
                                ...
                                <h5 class="font-size-15 mb-2">{{ $client->name }}</h5>
                                <p class="mb-1">{{ $client->whatsapp }}</p>
                        ...
                        <div class="col-sm-6">
                            <div class="text-muted text-sm-end">
                                <div>
                                    <h5 class="font-size-15 mb-1">Statements:</h5>
                                    <p>{{ $client->statments()->count() }}</p>
                                </div>
                                <div class="mt-4">
                                    <h5 class="font-size-15 mb-1">Invoices:</h5>
                                    <p>{{ $client->invoices()->count() }}</p>
                                </div>
                                <div class="mt-4">
                    ...
                    <div class="py-2">
                        <h5 class="font-size-15">Statement Summary</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-centered mb-0">
                                ...
                                <tbody>
                                	@foreach($client->invoices as $key => $invoice)
                                    <tr>
                                        <th scope="row">{{ ++$key }}</th>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-0 text-end">
                                        	<h4 class="m-0 fw-semibold">
                                        		{{ $client->invoices()->sum('amount') - $client->statments()->sum('amount')}}
                                        	</h4>
                                    	</td>
                                    </tr>
                                </tbody>
