...
@section('breadcrumb')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Update Client</h4>
    </div>
...
<div class="card wizard-content">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('clients.update', $client->id) }}" class="validation-wizard wizard-circle" role="form" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
